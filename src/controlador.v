...
module controlador #(
    ...
    // temporizador (substituindo anim_busy)
    input wire tempo_2s,
    output reg inicia_2s,
    ...
    // funcoes para decodificar a carta
    ...
    function automatic is_skiprev; input [9:0] c; is_skiprev = (c[9:8]==2'b01) && ((c[7:4]==4'b1010)||(c[7:4]==4'b1011)); endfunction
